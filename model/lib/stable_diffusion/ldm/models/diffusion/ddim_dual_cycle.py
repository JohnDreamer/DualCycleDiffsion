...
class DDIMSampler(object):
    ...
    def ddpm_ddim_encoding(self,
        ...
        z_list, x_list = self._ddpm_ddim_encoding(conditioning, size,
                                          callback=callback,
                                          img_callback=img_callback,
                                          quantize_denoised=quantize_x0,
    ...
    def _ddpm_ddim_encoding(self, cond, shape,
        ...
        # print('total step', total_steps, skip_steps, refine_steps, white_box_steps)
        # a_mid = alphas[(total_steps-x_mid_step)-1]
        # x_mid = a_mid.sqrt() * x0 + (1 - a_mid).sqrt() * noise
